...
| --- | --- | --- |
| [side-dock-elevation.html](side-dock-elevation.html) | Side dock (130×360) | The dock shipped as a 240 px opaque slab with an upside-down wordmark and nothing on it outside a dictation. Before/at-rest/recording elevations at 1:1, the row arithmetic, the placement diagram for the 24 px work-area inset, a change ledger, and the two defects only the running window showed. **Built** — geometry and placement measured against the live app. **The geometry it draws is superseded**: it depicts a 130-wide card with five rows (20 / 86 / 152 / 16 / 28), and the dock has since narrowed to 62 and gained a sixth row for the engine indicator (20 / 104 / 14 / 112 / 16 / 28, 2026-08-27). Superseded again on 2026-08-28, and this time in the order as well as the sizes: the window grew to 400 to pay for an action button present in every state, the engine row moved *below* the meter, and the clock row became a status row that also carries the outcome mark — 20 / 104 / 152 / 14 / 16 / 28. Superseded a third time on 2026-09-22: the engine row moved above the wordmark, the status row folded into the button, and a stray narrow-width padding rule stopped reaching the card — 20 / 14 / 90 / 182 / 36. The argument it makes still holds; the numbers on it were true when drawn and are not now. |
