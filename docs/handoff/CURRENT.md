...
| Workspace version | `& .\scripts\Get-ProductVersion.ps1` — currently `v1.11.0`, ahead of the published `v1.10.3`, so a build may proceed once the proofs below have run |
