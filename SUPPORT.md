...
SpeakEasy is a personal Windows tool shared privately with a few friends. It
has no institutional support, support team, response-time commitment, or
...
Security reports should follow [the security policy](docs/SECURITY.md), not a
public issue.
